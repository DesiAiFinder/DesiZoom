        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Desi Finder</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Your one-stop shop for all Desi needs. Find Indian businesses, events, 
              and community resources in your local area.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Desi Finder. All rights reserved.
            </p>
