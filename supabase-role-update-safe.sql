-- Desi Finder Role-Based System Update (Safe Version)
...
DROP POLICY IF EXISTS "Service providers can create events" ON events;
DROP POLICY IF EXISTS "Users can edit own events" ON events;
DROP POLICY IF EXISTS "Users can delete own events" ON events;
DROP POLICY IF EXISTS "Anyone can view active deals" ON deals;
DROP POLICY IF EXISTS "Service providers can create deals" ON deals;
DROP POLICY IF EXISTS "Users can edit own deals" ON deals;
...
-- Success message
SELECT 'Role-based system successfully updated! All users now have roles and proper permissions.' as message;
